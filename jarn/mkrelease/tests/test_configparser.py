...
""")
        ...
        self.assertEqual(parser.getstring('section', 's_val', single=True), 'fred')
...
""")
        ...
        self.assertEqual(parser.getstring('section', 'e_val', single=True), '')
...
""")
        ...
        self.assertEqual(parser.getstring('section', 'm_val', single=True), None)
...
""")
        ...
        self.assertEqual(parser.getstring('section', 'b_val', single=True), 'yes')
...
""")
        ...
        self.assertEqual(parser.getstring('section', 'i_val', single=True), '10')
...
""")
        ...
        self.assertEqual(parser.getstring('section', 'f_val', single=True), '0.1')
