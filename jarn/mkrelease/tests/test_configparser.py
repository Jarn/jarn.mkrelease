...
""")
        ...
        self.assertEqual(parser.getstripped('section', 's_val'), 'fred')
        self.assertEqual(parser.getline('section', 's_val'), 'fred')
...
""")
        ...
        self.assertEqual(parser.getstripped('section', 's_val'), None)
        self.assertEqual(parser.getline('section', 's_val'), None)
...
""")
        ...
        self.assertEqual(parser.getstripped('section', 'e_val'), '')
        self.assertEqual(parser.getline('section', 'e_val'), '')
...
""")
        ...
        self.assertEqual(parser.getstripped('section', 'm_val'), 'fred flintstone')
        self.assertEqual(parser.getline('section', 'm_val'), 'fred flintstone')
...
""")
        ...
        self.assertEqual(parser.getstring('section', 'm_val'), None)
        self.assertEqual(parser.getstripped('section', 'm_val'), 'fred\nflintstone')
        self.assertEqual(parser.getline('section', 'm_val'), 'fred flintstone')
        self.assertEqual(parser.getlist('section', 'm_val'), ['fred', 'flintstone'])
        self.assertEqual(parser.getboolean('section', 'm_val'), None)
        self.assertEqual(parser.getint('section', 'm_val'), None)
...
""")
        ...
        self.assertEqual(parser.getstripped('section', 'b_val'), 'yes')
        self.assertEqual(parser.getline('section', 'b_val'), 'yes')
...
""")
        ...
        self.assertEqual(parser.getstripped('section', 'i_val'), '10')
        self.assertEqual(parser.getline('section', 'i_val'), '10')
...
""")
        ...
        self.assertEqual(parser.getstripped('section', 'f_val'), '0.1')
        self.assertEqual(parser.getline('section', 'f_val'), '0.1')
