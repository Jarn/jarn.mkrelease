...
""")
        ...
        self.assertEqual(parser.getsingle('section', 's_val'), 'fred')
...
""")
        ...
        self.assertEqual(parser.getsingle('section', 's_val'), None)
        self.assertEqual(parser.getboolean('section', 's_val'), None)
        self.assertEqual(parser.getint('section', 's_val'), None)
        self.assertEqual(parser.getfloat('section', 's_val'), None)
...
""")
        ...
        self.assertEqual(parser.getsingle('section', 'e_val'), '')
...
""")
        ...
        self.assertEqual(parser.getsingle('section', 'm_val'), None)
...
""")
        ...
        self.assertEqual(parser.getsingle('section', 'b_val'), 'yes')
...
""")
        ...
        self.assertEqual(parser.getsingle('section', 'i_val'), '10')
...
""")
        ...
        self.assertEqual(parser.getsingle('section', 'f_val'), '0.1')
...
""")
    ...
    def test_warn_single_multi(self):
        self.mkfile('my.cfg', """
[section]
